    ...
    <SCourses id="courses" className="course-section pb-48 pt-48 px-4 lg:px-0">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl tracking-wide">The Courses</h2>
          <h3 className="text-xl arial tracking-wide text-gray-700">
        ...
        <div className="lg:grid grid-cols-2 gap-10 mb-10">
          ...
          <div className="bg-white shadow rounded overflow-hidden relative mb-8 lg:mb-0 px-2 lg:px-0">
            ...
            {/* apps */}
            <div className="grid grid-cols-3 gap-6 px-6 pb-10 text-center text-gray-600 leading-relaxed">
              <div className="col-span-2 bg-gray-100 rounded p-4 text-left">
                ...
                <a href="#apps" className="block text-blue-400">
                  View the apps
                </a>
              </div>
          ...
          <div className="bg-white shadow rounded overflow-hidden relative mb-8 lg:mb-0 px-2 lg:px-0">
            ...
            <div className="flex items-center justify-center relative z-10 py-8 mb-2">
              <FontAwesomeIcon
                ...
                color="#4b5ed5"
              />
              <h2 className="fugaz-one text-3xl leading-none text-purple-800">
                Make 10 React Apps{' '}
                <span className="block text-purple-600 opacity-75 mt-4 text-xl">
                  Series B
                </span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 px-6 pb-10 text-center text-gray-600 leading-relaxed">
              <div className="col-span-2 bg-gray-100 rounded p-4 text-left">
                ...
                <ol className="pl-4 mb-4">
                  ...
                  <li>Shopping Cart</li>
                  <li>Typing Speed Game</li>
                  <li>Gatsby Site</li>
                </ol>

                <a href="#apps" className="block text-purple-400">
                  View the course
                </a>
              </div>
              <div className="grid grid-cols-1 grid-rows-3 gap-8 leading-none">
          ...
          <div className="bg-white shadow rounded overflow-hidden relative">
            ...
            <div className="grid lg:grid-cols-11 gap-4 px-10 pb-10 text-lg text-gray-600 leading-snug relative z-10 text-center">
              ...
              <a
                ...
                style={{ boxShadow: '3px 3px 0 #9ae6b4' }}
              >
